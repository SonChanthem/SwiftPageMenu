...
extension PageMenuController: EMPageViewControllerDelegate {
    ...
    func em_pageViewController(_ pageViewController: EMPageViewController,
        ...
        self.delegate?.pageMenuController?(self, fromIndex: beforeIndex, toIndex: index, scrollingProgress: progress, direction: direction.toPageMenuNavigationDirection)
